...
This dataset is comprised of the intake and outcome record from the Long Beach Animal Shelter during 2017-2024. This analysis focuses on *cats only*. The total number of cats processed between 2017 and 2024 was 'r inline_text(longbeach, variable = '), only &&&& are included in this analysis.

Overall the participants got a median of `r inline_text(tbl_sex_sleep, variable = "sleep_wknd")` hours of sleep on the weekends. See **@tbl-median**.
...
Overall between 2017-2024 the best predictors of being dead at outcome among cats was 'r inline_text (tbl)
...
See @tbl-one for descriptive statistics.
```{r}
